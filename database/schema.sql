-- Web-Based Banking System Database Schema
...
-- Table: users
-- Stores admin and customer accounts for authentication
...
-- Table: customers
-- Stores customer information with account details
...
-- Password hash for 'admin123' using simple MD5 (in production, use bcrypt)
